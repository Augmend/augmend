  ...
  helpers do
    ...
    def handle_new_pull_request(payload)
      ...
      changed_files.each do |item|
        ...
        commit_id = "c4b1786c1bd3528b12e6ed22f3e2e23caf474cbe" # item.sha
          ...
          f.each_line do |line|
            ...
            BLOCK_WORDS.each do |word|
              if line.downcase.include?(word)
                ...
                body = "revisit this line to fix culturally insensitive language #{line_number + 1}" 

                # TODO make this comment a code suggestion instead
                # use the options parameter
                puts repo, pull_id, body, commit_id, file_name, (line_number + 1)
    ...
    def authenticate_installation(payload)
      ...
      @installation_client = Octokit::Client.new(access_token: PERSONAL_ACCESS_TOKEN)
    end
